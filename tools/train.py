...
parser.add_argument('--dataset_root', type=str, default = '/media/scratch1/jonfrey/datasets/YCB_Video_Dataset/', help='dataset root dir (''YCB_Video_Dataset'' or ''Linemod_preprocessed'')')
